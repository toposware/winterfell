...
impl Air for RangeAir {
    ...
    fn new(trace_info: TraceInfo, _pub_inputs: PublicInputs, options: ProofOptions) -> Self {
        ...
        degrees.push(TransitionConstraintDegree::with_cycles(2, vec![PERIOD / 2]));
        degrees.push(TransitionConstraintDegree::with_cycles(2, vec![PERIOD / 2]));
        degrees.push(TransitionConstraintDegree::with_cycles(1, vec![PERIOD * 2]));
        degrees.push(TransitionConstraintDegree::with_cycles(2, vec![PERIOD * 2]));
