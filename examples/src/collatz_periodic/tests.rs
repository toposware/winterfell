...
#[test]
fn collatz_periodic_test_basic_proof_verification() {
    let collatz = Box::new(super::CollatzExample::new(
        16,
        64,
...
#[test]
fn collatz_periodic_test_basic_proof_verification_extension() {
    let collatz = Box::new(super::CollatzExample::new(
        16,
        64,
...
#[test]
fn collatz_periodic_test_basic_proof_verification_fail() {
    let collatz = Box::new(super::CollatzExample::new(
        16,
        64,
        build_proof_options(false),
